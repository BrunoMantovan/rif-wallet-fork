...
const resources = {
  en: {
    translation: {
      ...
      info_box_title_search_domain: 'Usuario e Ícono',
      ...
      info_box_close_button: 'cerrar',
      initial_screen_title: 'Billetera',
      initial_screen_button_retry_login: 'Reintentar desbloqueo',
      initial_screen_button_create: 'Crear una billetera',
      initial_screen_button_import: 'Importar una billetera existente',
      initial_screen_welcome_footer:
        'Bienvenido a Bolsillo Argento',
      header_import_wallet: 'Importar billetera',
      header_enter_your_phrase: 'Introducir frase semilla',
      header_phrase_correct: 'La frase es correcta!',
      header_phrase_not_correct: 'La frase es incorrecta!',
      header_no_username: 'No hay usuario',
      header_requesting: 'Solicitando usuario...',
      ...
      mnemonic_title_copy: 'Copiado al portapapeles',
      mnemonic_body: `Asegurese de estar en un lugar seguro donde nadie pueda ver su pantalla antes de revelar la frase semilla. `,
      mnemonic_body_copy:
        'Le recomendamos escribir la frase en papel.',
      new_master_key_title: 'Guarde su frase',
      new_master_key_button_title: 'Frase asegurada, continuar',
      new_master_key_secure_later_button: 'Asegurar despues',
      ...
      contact_form_edit_existing_button: 'Editar contacto existente',
      transaction_form_label_asset: 'activo',
      ...
      initial_screen_button_reset_app: 'Reiniciar aplicación',
      contacts_delete_contact_description:
        '¿Está seguro de eliminar a ',
      wallet_backup_subtitle: 'Ver mi frase',
      wallet_backup_delete_button: 'Eliminar Billetera',
      wallet_backup_delete_confirmation_title: '¿Eliminar Billetera?',
