...
export const ReceiveScreen = ({
  ...
  const balancesArrayFiltered = Object.values(tokenBalances).filter(obj => obj.name === "RBTC" || obj.name === "Dollar on Chain" || obj.name === "tRIF Token" ||obj.name === "Dollar on Chain" || obj.name === "Testnet RIF Token" || obj.name === "MOC" ||obj.name === "BitPRO" || obj.name === "TestPDOC" || obj.name == "RIF")
